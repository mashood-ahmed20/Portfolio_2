      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            {/* Stats */}
            <div className="flex items-center justify-center lg:justify-start gap-8 md:gap-12 pt-8 animate-fade-in" style={{
            animationDelay: "0.4s"
          }}>
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in-right" style={{
          animationDelay: "0.2s"
        }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 px-4 py-2 rounded-xl glass-card animate-float" style={{
              animationDelay: "0.5s"
            }}>
