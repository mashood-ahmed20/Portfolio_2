...
const additionalSkills = [
  "HTML5", "CSS3", "JavaScript", "Express.js", 
  "UI/UX Design", "Responsive Design", "Git", "REST APIs"
];
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {additionalSkills.map((skill, index) => (
              <span
                key={skill}
                className="px-4 py-2 rounded-full bg-secondary border border-border/50 text-foreground text-sm font-medium hover:border-primary/50 hover:bg-primary/10 transition-all duration-300 cursor-default"
