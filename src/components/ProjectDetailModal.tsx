...
const ProjectDetailModal = ({ project, isOpen, onClose }: ProjectDetailModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[85vh] bg-card border-border flex flex-col p-0 gap-0 overflow-hidden">
        {/* Fixed Header */}
        ...
        <div className="overflow-y-auto flex-1 px-6 py-4 space-y-4">
          {/* Media Area */}
          <div className="relative aspect-video bg-gradient-to-br from-muted to-secondary rounded-lg overflow-hidden">
            {project.videoUrl ? (
              <VideoPlayer
